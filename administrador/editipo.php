...
$stmt = $conn->prepare("SELECT idtipo, descripcion FROM tipo_personal WHERE idtipo='".$_GET['id']."'");
$stmt->execute();
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="tipoprofesor.php">Tipo Profesor</a>
                                </li>
                                <li class="breadcrumb-item active">Edit Tipo
                                </li>
                            </ol>
                        </div>
                    </div>
