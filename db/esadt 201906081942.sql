...
--
-- Servidor: localhost
-- Tiempo de generación: 07-08-2019 a las 00:40:40
...
(5, NULL, NULL, NULL, 12, 12, 15, 18, 14, NULL, 14, 15, 15, NULL, NULL, 'N/A'),
(6, 3, 4, 8, 12, 14, 12, 12, 13, NULL, 13, 15, 14, 5, 70, 'N/A');
...
(5, 'DESARROLLO PERSONAL VOCACIONAL', 1, '3', '3', 1, '00'),
...
(7, 'ydiazballona', '$2y$10$HLMO7yHaCm10ZGqn.G74Nuak8gD4eE.TUgw12hcOIdl3mWkrwilly', 4, 2, NULL, '00'),
...
--
ALTER TABLE `resumen_asignatura`
  MODIFY `IdResumen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `subareas`
  MODIFY `IdSubArea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
