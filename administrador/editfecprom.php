...
$stmt = $conn->prepare("SELECT id, descripcion, f_activa, f_desactiva, id_periodo   FROM fecha_promedios WHERE id='".$_GET['id']."'");
$stmt->execute();   
        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Editar Fecha Promodio</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Editar Fecha de Promedios
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="date" name="fec_inc" class="form-control mb-1" value="<?=$result['f_activa']?>" required data-validation-required-message="Telephone is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="date" name="fec_fin" class="form-control mb-1" value="<?=$result['f_desactiva']?>" required data-validation-required-message="Telephone is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        <a href="fecprom.php" class="btn btn-danger">Cancel <i class="la la-close position-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
