                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="tel-repeater">Perfil de Usuario</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="app/update-profile.php" method="POST" autocomplete="OFF" enctype="multipart/form-data" >
                                        <div class="form-group col-12 mb-2">
                                            <input disabled="true" type="text" class="form-control" placeholder="Usuario" name="" value="<?php echo $myemail; ?>">
                                        </div>
                                        <div class="form-group col-12 mb-2">
                                        	<?php
			                                    if ($myvataor == null) { ?>
			                                    <img  src="../assets/admin/images/avatar.jpg" alt="avatar">

			                                    <?php }else{

			                                    print ' <img style="height: 150px; width:150px;" id="blah" class="card-img-left myavatar"  src="../assets/uploads/avatar/'.$myvataor.'" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'; }
			                                    ?>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form name="frm1" action="app/new-pw.php" method="POST" autocomplete="OFF">
                                        ...
                                        <div class="form-group col-12 mb-2">
                                            <input type="password" class="form-control" name="confirmpassword" placeholder="Confirmar nueva contraseña">
                                        </div>
